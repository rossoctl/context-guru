...
- acted-yield is **negligible but** refused-for-economics is **large** → `coref` is *economically
  ...
  [TTL observation](../../../proposals/coref-compaction.md#two-design-notes-from-review-neither-implemented),
  not more arms.
...
- **Neither merged design.** This tests `coref`'s *deterministic* dropping. It does not test the
  [merged call](../../../proposals/coref-compaction.md#two-design-notes-from-review-neither-implemented)
