...
The proposal (`docs/proposals/coref-compaction.md`) calls deferring the agent's own compaction its
largest claimed win. Implementation status (`docs/proposals/coref-implementation.md`) calls how often
...
**This is the first clause of the hypothesis (`docs/proposals/coref-compaction.md`) that does not fail.** Fired at
