...
The measurement pass `coref-compaction.md` §7 (`docs/proposals/coref-compaction.md`) says must run before
...
deferral gate (`docs/proposals/coref-compaction.md`). It is
